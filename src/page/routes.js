...
const DynamicVirtual = () => import(/* webpackChunkName: "dynamic" */ '../general/dynamic-virtual-list/index')
...
const routes =
  <Switch>
    ...
    <Route path='/react-demos/dynamic' component={createContainer(DynamicVirtual)} />
  </Switch>
